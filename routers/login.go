...
import (
	...
	"github.com/SergioPaez96/twitter_react/jwt"
...
func Login(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "Usuario y/o Contraserña inválidos"+err.Error(), 400)
		return
	}
	...
	if existe == false {
		http.Error(w, "Usuario y/o Contraserña inválidos", 400)
		return
	}
